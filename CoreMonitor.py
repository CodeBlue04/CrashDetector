...
def parse_request():
    ...
    return "300434063189070"


# -----------------------------
# - Mail stuff
EMAIL_ADDRESS = "colbyeaston@gmail.com"
EMAIL_PASSWORD = "nkpszhnrwsevqpys"
...
mail_settings = {
    ...
    'MAIL_USE_TLS': False,
    'MAIL_USE_SSL': True,
    'MAIL_USERNAME': "colbyeaston@gmail.com",
    'MAIL_PASSWORD': "nkpszhnrwsevqpys",
}
...
def sendMessage(message):
    contactList = ["2064783846@msg.fi.google.com"]
    with Emailer() as emailer:
        for recipient in contactList:
            emailer.send_email("colbyeaston@gmail.com", recipient, "Subject", message)
    return
